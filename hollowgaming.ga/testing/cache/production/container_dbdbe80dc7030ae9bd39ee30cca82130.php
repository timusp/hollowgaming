...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'bbtest_oauth_tokens', 'bbtest_oauth_states', 'bbtest_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'bbtest_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'bbtest_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'bbtest_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'bbtest_forums', 'bbtest_posts', 'bbtest_topics', 'bbtest_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('bbtest_captcha_questions', 'bbtest_captcha_answers', 'bbtest_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'bbtest_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'bbtest_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'bbtest_migrations', './../', 'php', 'bbtest_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'bbtest_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'bbtest_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'bbtest_notification_types', 'bbtest_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'bbtest_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'bbtest_notification_types', 'bbtest_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'bbtest_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'bbtest_profile_fields', 'bbtest_profile_lang', 'bbtest_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000695bc518000000005eeb7619(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'bbtest_bbcodes', 'bbtest_smilies', 'bbtest_styles', 'bbtest_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'bbtest_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'bbtest_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'bbtest_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'bbtest_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'bbtest_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'bbtest_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'bbtest_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'bbtest_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'bbtest_acl_groups',
            'tables.acl_options' => 'bbtest_acl_options',
            'tables.acl_roles' => 'bbtest_acl_roles',
            'tables.acl_roles_data' => 'bbtest_acl_roles_data',
            'tables.acl_users' => 'bbtest_acl_users',
            'tables.attachments' => 'bbtest_attachments',
            'tables.auth_provider_oauth_token_storage' => 'bbtest_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'bbtest_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'bbtest_oauth_accounts',
            'tables.banlist' => 'bbtest_banlist',
            'tables.bbcodes' => 'bbtest_bbcodes',
            'tables.bookmarks' => 'bbtest_bookmarks',
            'tables.bots' => 'bbtest_bots',
            'tables.captcha_qa_questions' => 'bbtest_captcha_questions',
            'tables.captcha_qa_answers' => 'bbtest_captcha_answers',
            'tables.captcha_qa_confirm' => 'bbtest_qa_confirm',
            'tables.config' => 'bbtest_config',
            'tables.config_text' => 'bbtest_config_text',
            'tables.confirm' => 'bbtest_confirm',
            'tables.disallow' => 'bbtest_disallow',
            'tables.drafts' => 'bbtest_drafts',
            'tables.ext' => 'bbtest_ext',
            'tables.extensions' => 'bbtest_extensions',
            'tables.extension_groups' => 'bbtest_extension_groups',
            'tables.forums' => 'bbtest_forums',
            'tables.forums_access' => 'bbtest_forums_access',
            'tables.forums_track' => 'bbtest_forums_track',
            'tables.forums_watch' => 'bbtest_forums_watch',
            'tables.groups' => 'bbtest_groups',
            'tables.icons' => 'bbtest_icons',
            'tables.lang' => 'bbtest_lang',
            'tables.log' => 'bbtest_log',
            'tables.login_attempts' => 'bbtest_login_attempts',
            'tables.migrations' => 'bbtest_migrations',
            'tables.moderator_cache' => 'bbtest_moderator_cache',
            'tables.modules' => 'bbtest_modules',
            'tables.notification_types' => 'bbtest_notification_types',
            'tables.notifications' => 'bbtest_notifications',
            'tables.poll_options' => 'bbtest_poll_options',
            'tables.poll_votes' => 'bbtest_poll_votes',
            'tables.posts' => 'bbtest_posts',
            'tables.privmsgs' => 'bbtest_privmsgs',
            'tables.privmsgs_folder' => 'bbtest_privmsgs_folder',
            'tables.privmsgs_rules' => 'bbtest_privmsgs_rules',
            'tables.privmsgs_to' => 'bbtest_privmsgs_to',
            'tables.profile_fields' => 'bbtest_profile_fields',
            'tables.profile_fields_data' => 'bbtest_profile_fields_data',
            'tables.profile_fields_options_language' => 'bbtest_profile_fields_lang',
            'tables.profile_fields_language' => 'bbtest_profile_lang',
            'tables.ranks' => 'bbtest_ranks',
            'tables.reports' => 'bbtest_reports',
            'tables.reports_reasons' => 'bbtest_reports_reasons',
            'tables.search_results' => 'bbtest_search_results',
            'tables.search_wordlist' => 'bbtest_search_wordlist',
            'tables.search_wordmatch' => 'bbtest_search_wordmatch',
            'tables.sessions' => 'bbtest_sessions',
            'tables.sessions_keys' => 'bbtest_sessions_keys',
            'tables.sitelist' => 'bbtest_sitelist',
            'tables.smilies' => 'bbtest_smilies',
            'tables.sphinx' => 'bbtest_sphinx',
            'tables.styles' => 'bbtest_styles',
            'tables.styles_template' => 'bbtest_styles_template',
            'tables.styles_template_data' => 'bbtest_styles_template_data',
            'tables.styles_theme' => 'bbtest_styles_theme',
            'tables.styles_imageset' => 'bbtest_styles_imageset',
            'tables.styles_imageset_data' => 'bbtest_styles_imageset_data',
            'tables.teampage' => 'bbtest_teampage',
            'tables.topics' => 'bbtest_topics',
            'tables.topics_posted' => 'bbtest_topics_posted',
            'tables.topics_track' => 'bbtest_topics_track',
            'tables.topics_watch' => 'bbtest_topics_watch',
            'tables.user_group' => 'bbtest_user_group',
            'tables.user_notifications' => 'bbtest_user_notifications',
            'tables.users' => 'bbtest_users',
            'tables.warnings' => 'bbtest_warnings',
            'tables.words' => 'bbtest_words',
            'tables.zebra' => 'bbtest_zebra',
...
class phpbbtemplatetwiglexer_00000000695bc518000000005eeb7619 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b29367313a9b224473656 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b29367313aa1331332187 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b29367313a88850131404 = array(
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, 'set_environment', array('env' => $env), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        return $this->valueHolder5b29367313a9b224473656->set_environment($env);
    }
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        return $this->valueHolder5b29367313a9b224473656->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        return $this->valueHolder5b29367313a9b224473656->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b29367313aa1331332187 = $initializer;
    }
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__get', array('name' => $name), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        if (isset(self::$publicProperties5b29367313a88850131404[$name])) {
            return $this->valueHolder5b29367313a9b224473656->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b29367313a9b224473656;
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__isset', array('name' => $name), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__unset', array('name' => $name), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;
    ...
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__clone', array(), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        $this->valueHolder5b29367313a9b224473656 = clone $this->valueHolder5b29367313a9b224473656;
    }

    public function __sleep()
    {
        $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, '__sleep', array(), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;

        return array('valueHolder5b29367313a9b224473656');
    }
    ...
    {
        return $this->initializer5b29367313aa1331332187;
    }
    ...
    {
        return $this->initializer5b29367313aa1331332187 && ($this->initializer5b29367313aa1331332187->__invoke($valueHolder5b29367313a9b224473656, $this, 'initializeProxy', array(), $this->initializer5b29367313aa1331332187) || 1) && $this->valueHolder5b29367313a9b224473656 = $valueHolder5b29367313a9b224473656;
    }
    ...
    {
        return null !== $this->valueHolder5b29367313a9b224473656;
    }
    ...
    {
        return $this->valueHolder5b29367313a9b224473656;
    }
