...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000211697fb0000000013c8a45c(
...
class phpbbtemplatetwiglexer_00000000211697fb0000000013c8a45c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b292f0a9c792864120014 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b292f0a9c798117994705 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b292f0a9c77e373052685 = array(
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, 'set_environment', array('env' => $env), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        return $this->valueHolder5b292f0a9c792864120014->set_environment($env);
    }
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        return $this->valueHolder5b292f0a9c792864120014->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        return $this->valueHolder5b292f0a9c792864120014->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b292f0a9c798117994705 = $initializer;
    }
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__get', array('name' => $name), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        if (isset(self::$publicProperties5b292f0a9c77e373052685[$name])) {
            return $this->valueHolder5b292f0a9c792864120014->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b292f0a9c792864120014;
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__isset', array('name' => $name), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__unset', array('name' => $name), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;
    ...
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__clone', array(), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        $this->valueHolder5b292f0a9c792864120014 = clone $this->valueHolder5b292f0a9c792864120014;
    }

    public function __sleep()
    {
        $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, '__sleep', array(), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;

        return array('valueHolder5b292f0a9c792864120014');
    }
    ...
    {
        return $this->initializer5b292f0a9c798117994705;
    }
    ...
    {
        return $this->initializer5b292f0a9c798117994705 && ($this->initializer5b292f0a9c798117994705->__invoke($valueHolder5b292f0a9c792864120014, $this, 'initializeProxy', array(), $this->initializer5b292f0a9c798117994705) || 1) && $this->valueHolder5b292f0a9c792864120014 = $valueHolder5b292f0a9c792864120014;
    }
    ...
    {
        return null !== $this->valueHolder5b292f0a9c792864120014;
    }
    ...
    {
        return $this->valueHolder5b292f0a9c792864120014;
    }
