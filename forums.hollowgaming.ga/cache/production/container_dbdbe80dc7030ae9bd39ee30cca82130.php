...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005b1c68e300000000630a9b02(
...
class phpbbtemplatetwiglexer_000000005b1c68e300000000630a9b02 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b289512da968513081854 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b289512da96e009747405 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b289512da956814778545 = array(
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, 'set_environment', array('env' => $env), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        return $this->valueHolder5b289512da968513081854->set_environment($env);
    }
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        return $this->valueHolder5b289512da968513081854->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        return $this->valueHolder5b289512da968513081854->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b289512da96e009747405 = $initializer;
    }
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__get', array('name' => $name), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        if (isset(self::$publicProperties5b289512da956814778545[$name])) {
            return $this->valueHolder5b289512da968513081854->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b289512da968513081854;
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__isset', array('name' => $name), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__unset', array('name' => $name), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;
    ...
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__clone', array(), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        $this->valueHolder5b289512da968513081854 = clone $this->valueHolder5b289512da968513081854;
    }

    public function __sleep()
    {
        $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, '__sleep', array(), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;

        return array('valueHolder5b289512da968513081854');
    }
    ...
    {
        return $this->initializer5b289512da96e009747405;
    }
    ...
    {
        return $this->initializer5b289512da96e009747405 && ($this->initializer5b289512da96e009747405->__invoke($valueHolder5b289512da968513081854, $this, 'initializeProxy', array(), $this->initializer5b289512da96e009747405) || 1) && $this->valueHolder5b289512da968513081854 = $valueHolder5b289512da968513081854;
    }
    ...
    {
        return null !== $this->valueHolder5b289512da968513081854;
    }
    ...
    {
        return $this->valueHolder5b289512da968513081854;
    }
